    ...
    class AuthController {
        ...
        */
        ...
        public function register() {
            ...
            try {
                if (!checkRateLimit('auth_register', 5, 900)) {
                    $this->json(["erro" => "Muitas tentativas. Tente novamente mais tarde."], 429);
                }
        ...
        */
        ...
        public function login() {
            ...
            try {
                if (!checkRateLimit('auth_login', 8, 900)) {
                    $this->json(["erro" => "Muitas tentativas. Tente novamente mais tarde."], 429);
                }
                ...
                $stmt = $this->conn->prepare("
                    SELECT id, nome_usuario, senha_usuario, tipo
                    FROM usuarios
                    WHERE login_usuario = ?
                    LIMIT 1
                ");
